				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa  fa fa-keyboard-o"></i>
						...
						<ul class="submenu">
							<!--<li class="">
								<a href="registrar_horario.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Registrar tutor de institución
								</a>

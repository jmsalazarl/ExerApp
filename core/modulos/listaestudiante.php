...
<html lang="en">
<head>
  <title>Listar Estudiantes - ExerApp</title>
  <?php
  if (!defined('ExerApp')) {
    die('Logged Hacking attempt!');
  }
  $data = getDataBySession($_COOKIE['session'], $db);
  include INC_DIR.'/list_est.php';
  include STATIC_DIR.'/header.php';
  ?>
</head>

<body class="no-skin">
  <?php include STATIC_DIR.'/menututorinstitucion.php';?>
                ...
                <tbody>
                  <?php foreach ($rows as $row) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['carrera_est'];?></td>
...
jQuery(function($) {
  ...
  var tableTools_obj = new $.fn.dataTable.TableTools( oTable1, {
...

    {
      ...
      "sMessage": "<div class='navbar navbar-default'><div class='navbar-header pull-left'><a class='navbar-brand' href='#'><small>Listado de Estudiantes</small></a></div></div>",
